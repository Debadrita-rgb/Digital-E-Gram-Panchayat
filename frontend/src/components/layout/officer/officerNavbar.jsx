...
export default function Example() {
  ...
  const navigation = [
    ...
    {
      name: "Services",
      href: "/officer/view-all-services",
      current:
        location.pathname.startsWith("/officer/view-all-services") ||
        location.pathname.startsWith("/officer/add-services") ||
        location.pathname.startsWith("/officer/edit-services"),
    },
    {
      name: "Application",
      href: "/officer/view-all-application",
      current:
        location.pathname.startsWith("/officer/view-all-application") ||
        location.pathname.startsWith("/officer/add-services") ||
        location.pathname.startsWith("/officer/edit-services"),
    },   
