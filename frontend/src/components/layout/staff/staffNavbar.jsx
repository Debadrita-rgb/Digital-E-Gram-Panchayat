...
export default function Example() {
  ...
  const navigation = [
    ...
    {
      name: "Application",
      href: "/staff/view-all-application",
      current:
        location.pathname.startsWith("/staff/view-all-application") ||
        location.pathname.startsWith("/staff/add-services") ||
        location.pathname.startsWith("/staff/edit-services"),
    },
  ];
